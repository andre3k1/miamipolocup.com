...
$us_zilla_shortcodes['blog'] = array(
	...
	'params' => array(
        ...
        'pagination' => array(
            ...
            'desc' => 'If checked, Posts Quantity parameter sets amount of Posts per page. Note: pagination works at static Pages only.',
        ),
	),
...
$us_zilla_shortcodes['social_links'] = array(
	...
	'shortcode' => '[social_links size="{{size}}" align="{{align}}" email="{{email}}" facebook="{{facebook}}" twitter="{{twitter}}" google="{{google}}" linkedin="{{linkedin}}" youtube="{{youtube}}" vimeo="{{vimeo}}" flickr="{{flickr}}" instagram="{{instagram}}" behance="{{behance}}" pinterest="{{pinterest}}" skype="{{skype}}" tumblr="{{tumblr}}" dribbble="{{dribbble}}" vk="{{vk}}" rss="{{rss}}"]',
